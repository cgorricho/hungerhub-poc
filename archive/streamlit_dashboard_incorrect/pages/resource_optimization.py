...
def calculate_resource_metrics(services_df):
    ...
    services_df['day_of_week'] = services_df['service_date'].dt.day_name()
    services_df['hour'] = services_df['service_date'].dt.hour
...
def render_resource_optimization():
    ...
    with col3:
        services_per_day = len(services_df) / services_df['service_date'].dt.date.nunique()
        st.metric(
    ...
    with col3:
        ...
        services_df['month'] = services_df['service_date'].dt.to_period('M')
    ...
    with col2:
        ...
        daily_services = services_df.groupby(services_df['service_date'].dt.date).size()

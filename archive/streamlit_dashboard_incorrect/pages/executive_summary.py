...
def render_executive_summary():
    ...
    with col1:
        ...
        # Monthly aggregation
        monthly_data = services_df.groupby(services_df['service_date'].dt.month).size().reset_index()
    ...
    with col2:
        ...
        service_types = services_df['service_type'].value_counts().head(5)
        fig = px.pie(
            values=service_types.values,
            names=service_types.index,

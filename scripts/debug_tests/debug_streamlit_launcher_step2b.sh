...
# STEP 2B DEBUG: CLI_ARGS with --server.port using space format
echo "🔍 STEP 2B: Testing --server.port with SPACE format (--server.port 8502)"
...
# CLI_ARGS with --server.port using space format
CLI_ARGS=(
  run
